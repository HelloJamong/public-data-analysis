"""
구글 Colab용 음주운전 데이터 분석 스크립트

사용 방법:
1. Colab에 이 파일을 업로드하거나 GitHub에서 직접 열기
2. CSV 데이터 파일을 Colab에 업로드
3. 모든 셀을 실행
"""
...
# ============================================
# 1. 구글 Colab용 한글 폰트 설정
# ============================================

# 나눔 폰트 설치 (Colab에는 맑은 고딕이 없으므로)
...
print(f"✓ '{csv_filename}' 파일 업로드 완료")
...
# ============================================
# 8. 생성된 이미지 파일 다운로드 (선택사항)
# ============================================

print("\n생성된 이미지 파일을 다운로드하시겠습니까?")
print("다음 셀을 실행하면 모든 이미지 파일을 다운로드할 수 있습니다:")
print("""
from google.colab import files

files.download('1_지역별_음주운전_적발건수.png')
files.download('2_나이대별_음주운전_적발건수.png')
files.download('3_지역별_나이대별_히트맵.png')
files.download('4_지역별_나이대_분포_누적.png')
""")
